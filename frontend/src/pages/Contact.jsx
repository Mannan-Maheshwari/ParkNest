    ...
    <main className="min-h-[calc(100vh-64px)] bg-slate-50 px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-8 shadow-soft">
          {sent && <div className="mb-5 rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700">Message captured for this demo.</div>}
          <div className="grid gap-5 sm:grid-cols-2"><label className="text-sm font-semibold">Name<input required className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3" /></label><label className="text-sm font-semibold">Email<input required type="email" className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3" /></label></div>
          <label className="mt-5 block text-sm font-semibold">Message<textarea required rows="6" className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3" /></label>
